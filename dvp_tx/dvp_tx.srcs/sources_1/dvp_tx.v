...
//-----Dummy Configurator------
wire [31:0] h_pad_left, h_pad_right, sync_width, v_pad_up, v_pad_down, video_h, video_v, sample;
// in px
assign video_h = 320; 
assign h_pad_left = 0; 
...
assign orientation = orientation_input;
assign sample = 1;
...
always@(posedge clk_20m or negedge aresetn) begin
  if(!aresetn) begin
    frame_en <= 0;
    data_pixel <= 12'h000;
    indicator <= 2'b00;
